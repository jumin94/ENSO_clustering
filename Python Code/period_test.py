...
def plot_clusters(original_grids,cluster_centers,clusters_in_order,values,labels,number): #clusters in order is an array of sorted clusters
    ...
    for dataset in dataset_list:
        ...
        for i in range(k):
            ...
            ax[i,counter].set_xticks([180,240])
    ...
    fig.savefig('/home/julia.mindlin/ENSO_favors/New_classification_eight_clusters/All_datasets_Kaplan_grid_1942-2022_'+str(number)+'_years.tiff')
    plt.close()
