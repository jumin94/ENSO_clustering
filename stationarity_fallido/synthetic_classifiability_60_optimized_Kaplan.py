...
year_num = 60
data_file_path = '/home/julia.mindlin/ENSO_favors/ENSO_clustering/data/sst.mean.anom_Kaplan_2022_KAPLAN_grid.nc'
output_file_path = '/home/julia.mindlin/ENSO_favors/ENSO_clustering/'+str(year_num)+'_year_noise_classification_dictionary_Kaplan.csv' 
