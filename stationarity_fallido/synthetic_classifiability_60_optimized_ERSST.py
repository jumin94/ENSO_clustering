...
year_num = 60
data_file_path = '/home/users/tabu/ENSO_clustering/data/sst.mnmean_ERSST_2022_KAPLAN_grid.nc'
output_file_path = '/home/users/tabu/ENSO_clustering/'+str(year_num)+'_year_noise_classification_dictionary_ERSST.csv' 
